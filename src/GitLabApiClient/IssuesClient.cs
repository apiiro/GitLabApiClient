...
namespace GitLabApiClient
{
    ...
    public sealed class IssuesClient : IIssuesClient
    {
        ...
        public async Task<IList<Note>> GetNotesAsync(ProjectId projectId, long issueIid, Action<IssueNotesQueryOptions> options = null)
        {
        ...
        public async Task<Note> UpdateNoteAsync(ProjectId projectId, long issueIid, long noteId, UpdateIssueNoteRequest request) =>
